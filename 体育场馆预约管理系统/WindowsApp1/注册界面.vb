...
Public Class 注册界面
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If (RadioButton1.Checked) Then
            cm = New SqlCommand("select count(*) from Users where ID='" + TextBox1.Text + "'", cn)
            Dim num1 = Convert.ToInt32(cm.ExecuteScalar())
            If (num1 = 0) Then

                sqlstr = "insert into  Users values('" + TextBox1.Text + "','" + TextBox4.Text + "','" + “校内人员" + "','" + TextBox2.Text + "')"
        ...
        ElseIf (RadioButton2.Checked) Then
            ...
            If (num2 = 0) Then
                ...
                sqlstr = "insert into  Users values('" + TextBox1.Text + "','" + TextBox4.Text + "','" + "校外人员" + "','" + TextBox2.Text + "')"
                cm = New SqlCommand(sqlstr, cn)
                cm.ExecuteNonQuery()
                cn.Close()
                MessageBox.Show("注册成功", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information)
